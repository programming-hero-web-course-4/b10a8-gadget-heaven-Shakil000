...
const Head = () => {
  ...
  useEffect(() => {
    ...
    return (
       ...
       <Link to= "/dashboard"> <FaRegHeart className="circle rounded-full bg-white h-10 w-10 p-2"/><p className='absolute top-5 right-28 bg-red-500 text-white rounded-full px-2 text-xs'>{wishCartCount}</p></Link>
        </div>
      </div>
    );
};
